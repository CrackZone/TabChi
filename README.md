#[Tablighchi](http://telegram.me/CrackZone)
...
git clone https://github.com/CrackZone/TabChi.git && cd TabChi && chmod 777 install.sh && chmod +x CrackZone.sh && ./install.sh
```
...
#Ch: [@CrackZone](http://telegram.me/CrackZone)

#Opened By: [Edit](http://telegram.me/Amir_017)
بعد از ساختن بوت اینو استارت کنید
#help bot: @Amir_017bot
